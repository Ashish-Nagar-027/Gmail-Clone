...
const SectionBar = () => {
  ...
  return (
    ...
    <Box sx={{ display:'flex', fontSize:'0.8rem'}}>
      ...
      sx={{ 
      width:'250px',
      borderBottom: activeBox ==='Primary'? '3px solid #1565C0 ': '3px solid white', 
      ...
      <BoxItem 
       onClick={(e) => setActiveBoxFunction(e)} 
      sx={{ width:'250px',
      borderBottom: activeBox ==='Promotions'? '3px solid #1565C0 ': '3px solid white', 
      color: activeBox ==='Promotions'? '#1565C0 ': '#444746' 
     }}
      className='Promotions'
      >
        <LocalOfferOutlinedIcon sx={{transform:'scale(0.8)'}} className="Promotions" />
      ...
      sx={{ 
        width:'250px',
        borderBottom: activeBox ==='Socials'? '3px solid #1565C0 ': '3px solid white', 
        color: activeBox ==='Socials'? '#1565C0 ': '#444746'  }}
      className='Socials'
      >
        <GroupOutlinedIcon sx={{transform:'scale(0.8)' }} className="Socials" />
